...
body.id = "cuerpo";
body.innerHTML = '<header id="encabezado"><nav id="navBar"></nav></header> <div id="divSeccionPrincipal"><section id="seccionPrincipal"></section></div><section id="piePagina"></section> <footer id=footer></footer>';
