function calculo() {
        ...
        case 2:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista2' id='divLista2'>
                                        ...
                                        <h4>AR:${arrayListas[1].AR}</h4>
                                        <h4>CF:${arrayListas[1].CF}</h4>
                                    </div>`;
        ...
        case 3:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista3' id='divLista3'>
                                        ...
                                        <h4>AR:${arrayListas[2].AR}</h4>
                                        <h4>CF:${arrayListas[2].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
        ...
        case 4:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista4' id='divLista4'>
                                        ...
                                        <h4>AR:${arrayListas[3].AR}</h4>
                                        <h4>CF:${arrayListas[3].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
        ...
        case 5:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista5' id='divLista5'>
                                        ...
                                        <h4>AR:${arrayListas[4].AR}</h4>
                                        <h4>CF:${arrayListas[4].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
        ...
        case 6:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista6' id='divLista6'>
                                        ...
                                        <h4>AR:${arrayListas[5].AR}</h4>
                                        <h4>CF:${arrayListas[5].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
        ...
        case 7:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista7' id='divLista7'>
                                        ...
                                        <h4>AR:${arrayListas[6].AR}</h4>
                                        <h4>CF:${arrayListas[6].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
        ...
        case 8:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista8' id='divLista8'>
                                        ...
                                        <h4>AR:${arrayListas[7].AR}</h4>
                                        <h4>CF:${arrayListas[7].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
        ...
        case 9:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista9' id='divLista9'>
                                        ...
                                        <h4>AR:${arrayListas[8].AR}</h4>
                                        <h4>CF:${arrayListas[8].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
        ...
        case 10:
            ...
            fichaListas.innerHTML = `<div class='divLista1' id='divLista1'>
                                    ...
                                    <div class='divLista10' id='divLista10'>
                                        ...
                                        <h4>AR:${arrayListas[9].AR}</h4>
                                        <h4>CF:${arrayListas[9].CF}</h4>
                                    </div>`;
            pie.appendChild(fichaListas);
    ...
    textoGanador.innerHTML = `<p>Se contabilizan un total de ${votosTotales} votos. Hubo ${totBlancos} votos blancos. La mayoría obtuvo ${arrayListas[0].votos} (${porcentajeMayoria}%) y la minoría ${votosMinoria} (${porcentajeMinoria}%).</p>`
